...
--
DROP DATABASE IF NOT EXISTS EMarket;
...
--
INSERT INTO
  `EmpleadoUbicaciones` (`EmpleadoID`, `UbicacionID`)
VALUES
  (5, '10019'),
  (5, '10038'),
  (5, '11747'),
...
--
INSERT INTO
  `Regiones` (`RegionesID`, `RegionesDescripcion`)
VALUES
  (1, 'Eastern'),
  (2, 'Western'),
  (3, 'Northern'),
...
--
INSERT INTO
  `Correos` (`CorreoID`, `Compania`, `Telefono`)
VALUES
...
INSERT INTO
  Categorias (CategoriaID, CategoriaNombre, Descripcion, Imagen)
VALUES
  (
    9,
    'Alcoholic Beverages',
    'Beer, wine, distilled spirits, fortified wines, cocktails',
    NULL
  ),
  (
    10,
    'Animal Food',
    'Food, pet food, snacks, training treats',
    NULL
  );
